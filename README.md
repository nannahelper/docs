...
在南京大学（"南哪"）学生技术社区中，我们发现大量同学对编程充满兴趣却苦于入门门槛过高——传统教程充斥着晦涩的专业术语、跳跃的知识结构，让初学者望而却步。本项目由此诞生，致力于打造一套 **"像朋友聊天一样学编程"** 的教程体系。
...
A: "南哪"是南京大学学生对自己学校的昵称（"哪"谐音"大"）。本项目最初由南大学生发起，面向校内技术社区，后开放给所有学习者。
