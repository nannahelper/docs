...
**南哪助手应用教程汇总** 是一个面向零基础学习者的开源教程集合，旨在通过通俗易懂的生活化比喻、手把手的实操步骤和丰富的代码示例，帮助新手从零开始掌握计算机、人工智能相关的基础知识与技能。

### 项目背景

在南哪学生社区中，我们发现大量同学尤其是非相关专业的同学对计算机、人工智能充满兴趣却苦于入门门槛过高——传统教程充斥着晦涩的专业术语、跳跃的知识结构，让初学者望而却步。本项目由此诞生，致力于打造一套 **"像朋友聊天一样学编程"** 的教程体系。
...
| 教程 | 内容 |
|:---|:---|
| [电脑与操作系统](content/cyber-computer-basics/index.md) | 从第一次开机开始，学习硬件、系统、文件、网络、外设和故障自救；约 5–6 小时 |
| [文件管理与备份](content/cyber-files-backup/index.md) | 从创建目录开始，学习命名、格式、下载、同步、备份和恢复；约 5–6 小时 |
| [互联网与浏览器](content/cyber-internet-basics/index.md) | 从连接 Wi-Fi 开始，学习网址、请求、开发者工具、登录和网页排错；约 5–6 小时 |
| [账号安全与隐私](content/cyber-account-security/index.md) | 从第一次登录开始，学习密码、2FA、钓鱼、设备隐私和 API Key；约 5–6 小时 |
| [搜索与信息判断](content/cyber-search-literacy/index.md) | 从写清问题开始，学习搜索、来源、资料卡、AI 核验和事实报告；约 5–6 小时 |
...
| 格式规范检查清单 | 粗体间距规则、自动化检查工具、写作工作流建议 |
...
| 章节 | 内容 |
|:---|:---|
| 文档基础操作 | 界面认知、文本编辑、格式刷、查找替换 |
| 样式与模板 | 样式系统、多级列表、模板创建与使用 |
| 表格与图表 | 表格设计、SmartArt、图片与图标插入 |
| 长文档编排 | 分节符、页眉页脚、自动目录、交叉引用 |
| 邮件合并 | 批量生成信函、标签、信封 |
| 协作与审阅 | 修订模式、批注、比较文档、共享文档 |
| 进阶技巧 | 域代码、宏录制、自定义功能区 |
| 综合实战项目 | 完整商业报告从零到交付 |
...
| 章节 | 内容 |
|:---|:---|
| 数字逻辑基础 | 硬件描述语言概念、逻辑门、布尔代数、设计流程 |
| 环境搭建 | Icarus Verilog 安装、GTKWave 波形查看、第一个程序 |
| 数据类型与运算符 | wire/reg、向量、数组、位运算与逻辑运算 |
| 模块与端口 | 模块定义、实例化、层次化设计、参数化模块 |
| 组合逻辑设计 | 多路选择器、译码器、编码器、ALU |
| 时序逻辑设计 | D 触发器、计数器、移位寄存器、时钟分频 |
| 状态机设计 | Moore/Mealy 状态机、三段式写法、交通灯控制器 |
| 综合实战 | 数字钟——整合分频、计时、显示、按键消抖 |
...
> **完整工作流请参阅 [CONTRIBUTING.md](CONTRIBUTING.md)** —— 包含新增/修改/删除教程的详细步骤和检查清单。
...
- 代码示例是否可运行
- 比喻是否恰当易懂
- **文件引用完整性（`mkdocs.yml`、`README.md`、`categories/*.md` 三处一致）**
