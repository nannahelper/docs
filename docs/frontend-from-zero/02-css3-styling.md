...
为第 1 章创建的博客文章页面添加 CSS 样式，实现以下效果：
...
3. 用浏览器打开页面，观察样式变化。
4. 按 F12 打开开发者工具，在 Styles 面板中查看每个元素应用的 CSS 规则。
5. 尝试修改颜色值（如将 `#667eea` 改为 `#e74c3c`），观察页面变化。
