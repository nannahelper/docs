...
| 项目 | 内容 |
|:---|:---|
| **学习目标** | 整合 HTML5、CSS3、JavaScript 三大技术，从零构建一个完整的响应式个人主页 |
| **核心比喻** | **精装样板房** —— 将前面学到的所有技能融会贯通，打造一个可以展示给别人的完整作品 |
| **预计时长** | 120 分钟 |
| **关键概念** | 项目结构设计、模块化 CSS、主题切换、平滑滚动、打字机效果、响应式导航 |
| **实践任务** | 完成个人主页的全部代码，并部署到 GitHub Pages |
