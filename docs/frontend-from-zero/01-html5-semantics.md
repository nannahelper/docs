...
现在，让我们把学到的知识整合起来，搭建一个结构完整的博客文章页面。
...
1. 将代码保存为 `blog-post.html`，用浏览器打开。
2. 检查页面是否包含页眉、导航、文章、侧边栏、页脚五个区域。
3. 按 F12 打开开发者工具，在 Elements 面板中查看 DOM 树结构。
4. 尝试修改标题文字和作者名字，刷新页面看效果。
