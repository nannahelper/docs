...
**渲染效果：** 简历排版紧凑专业，个人信息居中醒目，各板块用加粗标题分隔，时间线用右对齐排列，整体一页纸呈现。

## 4.3 案例三：学术幻灯片（Beamer）
...
**渲染效果：** 生成 PDF 幻灯片，每页一个 `frame`，有统一的主题样式（Madrid 主题为蓝色调），自动生成目录页，适合学术演讲和答辩。
...
1. 在 Overleaf 上创建一个项目，编译运行本章的论文模板。
2. 用 LaTeX 制作一份自己的简历。

### 进阶挑战

3. 找一篇你感兴趣的学术论文，尝试用 LaTeX 复现其排版。
4. 用 Beamer 制作一份 5 页的学术演讲幻灯片。
