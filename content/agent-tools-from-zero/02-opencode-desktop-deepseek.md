...
![OpenCode Desktop 简体中文首页与设置入口示例](../assets/opencode-desktop-settings.png)

> 上图为 OpenCode Desktop 的简体中文界面示例，用于帮助定位设置入口和“打开项目”按钮；Provider 与模型配置需要进入项目后再操作。当前版本的界面布局、语言选项和翻译可能不同，请以你安装的版本为准。
