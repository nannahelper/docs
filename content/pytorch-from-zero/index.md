...
| 章节 | 核心问题 | 核心比喻 | 预计时长 |
|:---|:---|:---|:---:|
| [第 1 章：张量操作基础](01-tensor-basics.md) | PyTorch 的"数字"长什么样？ | 张量 = 多维数组容器 | 35 分钟 |
| [第 2 章：自动求导机制](02-autograd.md) | PyTorch 如何自动计算梯度？ | 计算图 = 流水线记录仪 | 35 分钟 |
| [第 3 章：构建神经网络](03-building-models.md) | 如何用 PyTorch 搭建网络？ | nn.Module = 乐高积木 | 40 分钟 |
| [第 4 章：训练流程全解析](04-training-pipeline.md) | 一个完整的训练循环怎么写？ | 训练 = 健身计划 | 45 分钟 |
| [第 5 章：数据加载与预处理](05-data-loading.md) | 如何高效地喂数据给模型？ | DataLoader = 传送带 | 30 分钟 |
| [第 6 章：优化器与损失函数](06-optimization.md) | 如何选择正确的优化策略？ | 优化器 = 导航仪 | 30 分钟 |
| [第 7 章：GPU 训练与性能优化](07-gpu-training.md) | 如何让训练快 100 倍？ | GPU = 千人工厂 | 35 分钟 |
| [第 8 章：完整项目实战](08-complete-project.md) | 如何从零完成一个深度学习项目？ | 项目 = 烹饪全流程 | 60 分钟 |
