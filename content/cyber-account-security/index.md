...
| 章节 | 主题 | 你会得到什么 | 预计时长 |
|:---|:---|:---|:---:|
| [第 1 章：账号、设备和风险](01-accounts-threats.md) | 注册、登录、资产和威胁 | 画出个人账号地图 | 8 分钟 |
| [第 2 章：密码和密码管理器](02-passwords.md) | 唯一密码、主密码和恢复 | 建立可持续的密码习惯 | 8 分钟 |
| [第 3 章：双因素认证](03-two-factor.md) | TOTP、设备确认、恢复码 | 配置并测试 2FA | 10 分钟 |
| [第 4 章：钓鱼和危险授权](04-phishing-permissions.md) | 域名、链接、附件和 OAuth | 安全处理可疑消息 | 10 分钟 |
| [第 5 章：隐私和设备安全](05-privacy-devices.md) | 锁屏、权限、公共电脑和共享 | 降低日常泄露风险 | 8 分钟 |
| [第 6 章：API Key 与泄露响应](06-api-key-response.md) | 密钥、撤销、轮换和账单 | 写出应急响应卡 | 10 分钟 |
