...
| 章节 | 标题 | 核心内容 | 预计时长 |
|:---:|:---|:---|:---:|
| 1 | 数字逻辑基础与 Verilog 概述 | 硬件描述语言概念、数字电路基础、设计流程 | 30 分钟 |
| 2 | 开发环境搭建与第一个程序 | Icarus Verilog 安装、GTKWave 波形查看、Hello World | 25 分钟 |
| 3 | 数据类型与运算符 | wire/reg、向量、数组、运算符优先级 | 35 分钟 |
| 4 | 模块与端口 | 模块定义、端口声明、实例化、层次化设计 | 35 分钟 |
| 5 | 组合逻辑设计 | assign 语句、always 块、多路选择器、译码器 | 40 分钟 |
| 6 | 时序逻辑设计 | 时钟与复位、D 触发器、计数器、寄存器 | 40 分钟 |
| 7 | 状态机设计 | Moore/Mealy 状态机、状态编码、交通灯控制器 | 40 分钟 |
| 8 | 综合实战项目 | 数字钟设计——整合计数器、显示译码、按键消抖 | 60 分钟 |
