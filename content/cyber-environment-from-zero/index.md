...
| 章节 | 主题 | 核心比喻 | 预计时长 |
|:---|:---|:---|:---:|
| 第 1 章 | 认识终端与环境变量 | 给电脑一张地址簿 | 60 分钟 |
| 第 2 章 | 配置 C/C++ 编译环境 | 把施工图变成机器 | 90 分钟 |
| 第 3 章 | Python 与包管理器 | 给项目准备隔离工具箱 | 90 分钟 |
| 第 4 章 | Git 与 Shell 工具 | 给项目装上存档和遥控器 | 75 分钟 |
| 第 5 章 | 综合验证与排错 | 完成一次开机自检 | 120 分钟 |
