...
- `python-install-path.png` — Python 安装界面，勾选 Add to PATH
...
| `opencode-desktop-settings.png` | [《试用 opencode 一周，我把 Claude Code 扔了》](https://juejin.cn/post/7599965904617242670) 中的 OpenCode Desktop 简体中文界面截图；用于定位设置入口和打开项目按钮 |
