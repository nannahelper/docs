...
<div class="course-grid">
  <a class="course-card" href="../python-from-zero/index.md"><span class="course-tag">通用基础</span><h3>Python 新手指南</h3><p>从运行第一段代码，到文件处理和命令行项目。</p><span class="course-meta">5 章 · 约 8–10 小时</span></a>
  <a class="course-card" href="../c-from-zero/index.md"><span class="course-tag">系统 / 嵌入式</span><h3>C 语言新手指南</h3><p>理解类型、指针、内存和结构化程序设计。</p><span class="course-meta">5 章 · 约 10–12 小时</span></a>
